        ...
        if appointmentId != '':
            recordset = {
                "Update": {
                    ...
                    "UpdateExpression": "REMOVE GSI8PK, GSI8SK SET #s = :status, GSI1SK = :key, GSI2SK = :key2, MODIFIED_DATE = :mod_date, TIMECHECKIN = :dateOpe, PEOPLE_QTY = :qty, GSI5PK = :key05, GSI5SK = :skey05, GSI6PK = :key06, GSI6SK = :skey06, GSI7PK = :key07, GSI7SK = :skey07, GSI9SK = :key, GSI10SK = :key10", 
                    "ExpressionAttributeValues": {
                        ":status": {"N": "3"}, 
